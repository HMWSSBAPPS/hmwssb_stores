...
class StoreQcDgmManagerScreen extends StatefulWidget {
  const StoreQcDgmManagerScreen({super.key});

  @override
  State<StoreQcDgmManagerScreen> createState() => _StoreQcDgmManagerScreenState();
}

class _StoreQcDgmManagerScreenState extends State<StoreQcDgmManagerScreen>{
