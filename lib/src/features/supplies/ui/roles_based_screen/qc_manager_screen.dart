...
class StoreQcManagerScreen extends StatefulWidget {
  const StoreQcManagerScreen({super.key});

  @override
  State<StoreQcManagerScreen> createState() => _StoreQcManagerScreenState();
}

class _StoreQcManagerScreenState extends State<StoreQcManagerScreen>{
