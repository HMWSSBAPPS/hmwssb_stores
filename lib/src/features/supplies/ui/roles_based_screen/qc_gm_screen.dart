...
class StoreQcGmManagerScreen extends StatefulWidget {
  const StoreQcGmManagerScreen({super.key});

  @override
  State<StoreQcGmManagerScreen> createState() => _StoreQcGmManagerScreenState();
}

class _StoreQcGmManagerScreenState extends State<StoreQcGmManagerScreen>{
